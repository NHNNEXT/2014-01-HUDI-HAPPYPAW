...
<link rel="stylesheet" type="text/css" href="/nyam/user/css/historyPeriod.css">
	...
	<div class="list">
<% 
		ArrayList<HashMap<String, Object>> historyPeriod = (ArrayList<HashMap<String, Object>>) request.getAttribute("list");
		String id = (String)request.getAttribute("restId");
		...
		<ul class="months hidden">
			...
			%>
			<li class="month"><a href="/nyam/admin/eachRestaurant?restaurantId=<%=id%>&year=<%=year%>&month=<%=month%>"><%=month+1%> 월</a></li>
				<%
					}
				%>
		</ul> 
